...
var ActivityMaster = {
    ...
    CRMaster = {
        'ColModal': [
            ...
            {
                name: "s_MasterCode", width: 250, edittype: 'text', editrules: { required: true },
                editable: true, editoptions: { size: 8, maxlength: 8 }/*, editrules: { required: true, custom: [checkUnique, "s_MasterCode"]} */
            },
            ...
            { name: "s_value6", index: 's_value6', width: 250, editable: true, hidden: true, edittype: 'select', editrules: { edithidden: true }, required: true, editoptions: { dataUrl: '/Master/Master1?parentid=4272&IsActive=true', custom_value: myvalue } },
